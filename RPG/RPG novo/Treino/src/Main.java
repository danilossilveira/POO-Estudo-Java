...
public class Main {
    public static void main(String[] args) {
        ...
        int escolhaSeuPersonagem = scan.nextInt();




        //Escolha do seu personagem
        ...
        System.out.println("Agora escolha a classe do inimigo");
        System.out.println("1- "+ arqueiro.getNome());
        System.out.println("2- "+ pirotecnica.getNome());
        System.out.println("3- "+ mega.getNome());
        System.out.println("4- "+ golen.getNome());
        ...
        //Escolha do inimigo
        int escolhaInimigo = scan.nextInt();

        if (escolhaInimigo == 1) {
            inimigo.setNome(arqueiro.getNome());
            inimigo.setIdade(arqueiro.getIdade());
            inimigo.setAtaque(arqueiro.getAtaque());
            inimigo.setVida(arqueiro.getVida());
            System.out.println("Você escolheu o " + arqueiro.getNome());
            System.out.println("1- Atacar");
            System.out.println("2- Ver stats");

        } else if (escolhaInimigo == 2) {
            inimigo.setNome(pirotecnica.getNome());
            inimigo.setIdade(pirotecnica.getIdade());
            inimigo.setAtaque(pirotecnica.getAtaque());
            inimigo.setVida(pirotecnica.getVida());
            System.out.println("Você escolheu a " + pirotecnica.getNome());
            System.out.println("1- Atacar");
            System.out.println("2- Ver stats");
        } else if (escolhaInimigo == 3) {
            inimigo.setNome(mega.getNome());
            inimigo.setIdade(mega.getIdade());
            inimigo.setAtaque(mega.getAtaque());
            inimigo.setVida(mega.getVida());
            System.out.println("Você escolheu o " + mega.getNome());
            System.out.println("1- Atacar");
            System.out.println("2- Ver stats");
        } else if (escolhaInimigo == 4) {
            inimigo.setNome(golen.getNome());
            inimigo.setIdade(golen.getIdade());
            inimigo.setAtaque(golen.getAtaque());
            inimigo.setVida(golen.getVida());
            System.out.println("Você escolheu o " + golen.getNome());
            System.out.println("1- Atacar");
            System.out.println("2- Ver stats");
        } else {
        ...
        while (inimigo.getVida() > 0) {
            acao = scan.nextInt();
            if (acao == 1) {
                inimigo.setVida(inimigo.getVida() - escolhido.getAtaque());
                escolhido.setVida(escolhido.getVida()- inimigo.getAtaque());

                System.out.println("ataque feito, o inimigo " + inimigo.getNome() + " ficou com " + inimigo.getVida() + " de vida");
                System.out.println("O inimigo te atacou, você ficou com " + escolhido.getVida() + " de vida");
                System.out.println("digite 1 para atacar de novo");
                if (inimigo.getVida()<0 || escolhido.getVida()<0){
